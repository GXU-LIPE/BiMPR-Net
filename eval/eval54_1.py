...
parser.add_argument('--test_category', type=str, default='watercraft')
parser.add_argument('--Test_record_path', type=str, default='/data/home-gxu/ly21/XMFnet/log/models_svd_dual54_xiaorong1/models_svd_dual54_xiaorong1_0.1_80_watercraft_train54_1_Tue Nov 28 14:16:16 2023/Test_record')
...
ViPCDataset_test = ViPCDataLoader('output.txt', data_path=opt.dataroot, status="test", category=args.test_category)
