...
from models.SVDDual6 import Model
...
##### 运行测试程序时记得修改下列配置
test_category = 'table'
Test_record_path = '/data/home-gxu/ly21/XMFnet/log/models_svd_dual6/models_svd_dual6_0.1_192_table_train36_Fri Nov 10 23:17:27 2023/Test_record'
...
checkpoint = os.path.join(Test_record_path, 'best_model_table.pth')
