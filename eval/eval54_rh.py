...
parser.add_argument('--test_category', type=str, default='cabinet')
parser.add_argument('--Test_record_path', type=str, default='/data/home-gxu/ly21/XMFnet/log/models_svd_dual54_rh/models_svd_dual54_rh_0.1_80_cabinet_train54_rh_Mon Jan 15 05:57:15 2024/Test_record')
