...
parser.add_argument('--test_category', type=str, default='couch')
parser.add_argument('--Test_record_path', type=str, default='/data/home-gxu/ly21/XMFnet/log/models_svd_dual54_rhlo/models_svd_dual54_rhlo_0.1_80_watercraft_train54_rhlo_Thu Jan 18 07:57:34 2024/Test_record')
...
# checkpoint = os.path.join(args.Test_record_path, 'ckpt_2.pt')
