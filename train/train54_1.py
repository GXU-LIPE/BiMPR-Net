...
from models.SVDDual54_1 import Model
...
MODEL = 'models_svd_dual54_xiaorong1'
FLAG = 'train54_1'
DEVICE = 'cuda:0'
VERSION = '0.1'
...
parser.add_argument('--CLASS', type=str, default='plane')
...
def train_one_step(data, optimizer, network):
    ...
    coarse, complete = network(partial, image)
