...
class Refinement(nn.Module):
    def __init__(self, dim_1=256, dim=768):
        ...
        self.cross1 = cross_attention(dim_1, dim_1, dropout=0.0, nhead=8)
...
class SDG(nn.Module):
    ...
    def forward(self, local_feat, coarse, f_g, partial):
        ...
        feat_fine, F_H = self.refine_1(local_feat, F)  # (B,768,512) (B,768,512)
        feat_fine, F_H = self.refine_2(F_H, feat_fine)  # (B,512,512) (B,512,512)
        feat_fine, F_H = self.refine_3(F_H, feat_fine)  # (B,512,512) (B,512,512)
...
class Model(nn.Module):
    ...
    def forward(self, partial, depth, image):
        ...
        fine1 = self.refine(local_feat, coarse_merge, feat_g, partial)
